...
const checkPermission = (req, res, next) => {
  // Check if the user has permission to unlist categories
  // You'll need to implement your own logic to verify permissions here
  const userHasPermission = checkUserPermissionSomehow(); 

  if (userHasPermission) {
    next(); // User has permission, proceed to the actual function
  } else {
