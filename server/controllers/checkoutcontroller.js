...
const KEY_ID='rzp_test_v8PCaJHB5kU6bu';
const key_secret='AIArYKyq7lDH2Hroh7XvFSes';
      ...
      const availableCoupons = await couponModel.find({
        ...
        if (existingUser) {
            ...
            if (existingAddress) {
                ...
                return res.render("user/checkout", { addresses, cartItems, categories, cart,availableCoupons, addressExistsWarning: true });
            }
        ...
        res.render("user/checkout",{addresses,cartItems,categories,cart, availableCoupons,addressExistsWarning: true})
    } catch (error) {
        console.log(error);
        res.send(error)
    }
